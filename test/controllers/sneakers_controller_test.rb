...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { brand_id: @sneaker.brand_id, model: @sneaker.model, price: @sneaker.price, sex: @sneaker.sex } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { brand_id: @sneaker.brand_id, model: @sneaker.model, price: @sneaker.price, sex: @sneaker.sex } }
